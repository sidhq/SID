...
function SidSVG({ width, height, fill }: sidSVGProps) {
  return (
    <svg width={width} height={height} viewBox='0 0 220 94' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
...
const SIDButton: React.FC<SIDButtonProps> = ({
  width = 250,
  height = 40,
  fontScale = 1,
  isConnected = false,
  ...
  if (isConnected) {
    ...
    return (
      <div className={className} style={styles.dualButton}>
        <a
          href={manageURL}
          target={target}
