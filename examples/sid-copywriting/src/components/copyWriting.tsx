...
export default function CopyWriting() {
    ...
    const templates: Template[] = [{
        ...
        input: 'Write 3 sentences explaining why the copywriting AI company <company name> could use SID. Use an example of how linking mail and knowledge bases can help their product.',
        outputWithSID: 'SID\'s API simplifies the integration of user data into AI applications. For example, <Company Name> could get detailed context on each user\'s prompt by enabling them to link their knowledge base and email history. This allows <Company Name> generate more tailored, precise and effective copy.',
        outputWithoutSID: 'Using Sentence Intent Detection (SID), <company mame>, can generate more relevant and targeted content by understanding the intent behind each sentence. For example, when creating emails, SID can discern whether the user wants to inform, persuade, or inquire. Whether creating knowledge bases or generating emails, SID ensures that <cmpany name> content is accurate and aligned with the user\s intent.',
    }, {
        ...
        outputWithSID: 'I hope this email finds you well amidst the <city> startup hustle! As fellow <university> alumni, it\'s amusing to discover that w\'ve both mastered the art of balancing business acumen with coding finesse – who would\'ve thought? 😄',
