...
const ConnectSidButton: React.FC<ConnectSidButtonProps> = ({width, height, fontScale, isConnected, onDisconnect, href}) => {
    ...
    if (isConnected) {
        ...
        const styles = {
            ...
            leftButton: {
                boxShadow: isHoveredLeft ? "inset 0 0 0 150px rgba(12, 12, 12, 0.15)" : "none",
            ...
            rightButton: {
                boxShadow: isHoveredRight ? "inset 0 0 0 150px rgba(244,231,212, 0.05)" : "none",
                transition: "0.3s ease 0s",
                fontFamily: "'Montserrat', sans-serif",
                fontSize: `${(16*fontScale).toFixed(2)}px`,
                cursor: "pointer",
        ...
        const styles = {
            button: {
                filter: "drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25))",
                boxShadow: isHovered ? "inset 0 0 0 150px rgba(244,231,212, 0.05)" : "none",
                transition: "0.3s ease 0s",
                borderRadius: "10px",
                backgroundColor: "#0C0C0C",
                color: "#F4E7D4",
